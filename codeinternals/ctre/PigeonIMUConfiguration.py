...
class PigeonIMUConfiguration(CustomParamConfiguration):
    ...
    def toString(self, *args, **kwargs):  # real signature unknown; restored from __doc__
        ...
        1. toString(self: ctre._ctre.PigeonIMUConfiguration) -> str
        
        
        
        :returns: String representation of configs
        
        2. toString(self: ctre._ctre.PigeonIMUConfiguration, prependString: str) -> str
    ...
    def __init__(self):  # real signature unknown; restored from __doc__
        """ __init__(self: ctre._ctre.PigeonIMUConfiguration) -> None """
        pass
