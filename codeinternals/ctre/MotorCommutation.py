...
class MotorCommutation(__pybind11_builtins.pybind11_object):
    """
    ...
    def __init__(self, arg0): # real signature unknown; restored from __doc__
        """ __init__(self: ctre._ctre.MotorCommutation, arg0: int) -> None """
        pass

    def __int__(self): # real signature unknown; restored from __doc__
        """ __int__(self: ctre._ctre.MotorCommutation) -> int """
        return 0
    ...
    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ (self: ctre._ctre.MotorCommutation, arg0: int) -> None """
        pass
...
"""
    ...
    Trapezoidal = MotorCommutation.Trapezoidal
    __entries = {
        'Trapezoidal': (
