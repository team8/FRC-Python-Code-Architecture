...
class CANCoderFaults(__pybind11_builtins.pybind11_object):
    """ Faults available to CANCoderFaults """

    def hasAnyFault(self):  # real signature unknown; restored from __doc__
        """
        hasAnyFault(self: ctre._ctre.CANCoderFaults) -> bool
    ...
    def toBitfield(self):  # real signature unknown; restored from __doc__
        """
        toBitfield(self: ctre._ctre.CANCoderFaults) -> int
    ...
    def update(self, bits):  # real signature unknown; restored from __doc__
        """
        update(self: ctre._ctre.CANCoderFaults, bits: int) -> None
    ...
    def __init__(self, *args, **kwargs):  # real signature unknown; restored from __doc__
        ...
        1. __init__(self: ctre._ctre.CANCoderFaults, bits: int) -> None
        
        Updates current fault list with specified bit field of faults
        
        :param bits: bit field of faults to update with
        
        2. __init__(self: ctre._ctre.CANCoderFaults) -> None
        """
        pass
