...
class BaseTalonConfigUtil(__pybind11_builtins.pybind11_object):
    ...
    def reverseLimitSwitchDeviceIDDifferent(self, settings):  # real signature unknown; restored from __doc__
        """ reverseLimitSwitchDeviceIDDifferent(settings: ctre._ctre.BaseTalonConfiguration) -> bool """
        return False

    def reverseLimitSwitchDifferent(self, settings):  # real signature unknown; restored from __doc__
        """ reverseLimitSwitchDifferent(settings: ctre._ctre.BaseTalonConfiguration) -> bool """
        return False

    def reverseLimitSwitchNormalDifferent(self, settings):  # real signature unknown; restored from __doc__
        """ reverseLimitSwitchNormalDifferent(settings: ctre._ctre.BaseTalonConfiguration) -> bool """
        return False

    def reverseLimitSwitchSourceDifferent(self, settings):  # real signature unknown; restored from __doc__
        """ reverseLimitSwitchSourceDifferent(settings: ctre._ctre.BaseTalonConfiguration) -> bool """
        return False

    def sum0TermDifferent(self, settings):  # real signature unknown; restored from __doc__
        """ sum0TermDifferent(settings: ctre._ctre.BaseTalonConfiguration) -> bool """
        return False

    def sum1TermDifferent(self, settings):  # real signature unknown; restored from __doc__
        """ sum1TermDifferent(settings: ctre._ctre.BaseTalonConfiguration) -> bool """
        return False

    def __init__(self):  # real signature unknown; restored from __doc__
        """ __init__(self: ctre._ctre.BaseTalonConfigUtil) -> None """
        pass
