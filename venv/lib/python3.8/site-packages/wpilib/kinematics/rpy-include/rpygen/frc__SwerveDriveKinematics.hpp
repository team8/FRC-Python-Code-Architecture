...
inline void bind_frc__SwerveDriveKinematics(py::module &m, const char * clsName) {

        using namespace frc;


    py::class_<typename frc::SwerveDriveKinematics<NumModules>>
...
"          @endcode")
      ...
      .def("toChassisSpeeds", static_cast<ChassisSpeeds (frc::SwerveDriveKinematics<NumModules>::*)(std::array<SwerveModuleState, NumModules >)>(
...
":returns: The resulting chassis speed.")
      ...
      .def_static("normalizeWheelSpeeds", [](std::array<SwerveModuleState, NumModules> moduleStates, units::meters_per_second_t attainableMaxSpeed) {
