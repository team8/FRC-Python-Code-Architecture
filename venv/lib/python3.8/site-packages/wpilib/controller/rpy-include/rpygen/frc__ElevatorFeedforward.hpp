...
inline void bind_frc__ElevatorFeedforward(py::module &m, const char * clsName) {
...
using ka_unit = typename frc::ElevatorFeedforward<Distance>::ka_unit;
    ...
    py::class_<typename frc::ElevatorFeedforward<Distance>, std::shared_ptr<typename frc::ElevatorFeedforward<Distance>>>
