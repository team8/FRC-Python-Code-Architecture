...
template <typename CxxBase, typename Distance>
struct Pyfrc__ProfiledPIDController : PyBasefrc__ProfiledPIDController<CxxBase> {
    using PyBasefrc__ProfiledPIDController<CxxBase>::PyBasefrc__ProfiledPIDController;
...
inline void bind_frc__ProfiledPIDController(py::module &m, const char * clsName) {

        using namespace frc;
using Velocity = typename frc::ProfiledPIDController<Distance>::Velocity;


    py::class_<typename frc::ProfiledPIDController<Distance>, std::shared_ptr<typename frc::ProfiledPIDController<Distance>>, rpygen::Pyfrc__ProfiledPIDController<typename frc::ProfiledPIDController<Distance>, Distance>, Sendable>
