...
struct Pyfrc__SendableBuilder : CxxBase {
...
RPYBUILD_OVERLOAD_PURE_NAME(SendableBuilder,void, CxxBase, "setSmartDashboardType", SetSmartDashboardType,type);    }
#endif

#ifndef RPYGEN_DISABLE_SetActuator_b
    void SetActuator(bool value) override {
RPYBUILD_OVERLOAD_PURE_NAME(SendableBuilder,void, CxxBase, "setActuator", SetActuator,value);    }
#endif

#ifndef RPYGEN_DISABLE_SetSafeState_Tstd__function_void___
    void SetSafeState(std::function<void ( )> func) override {
RPYBUILD_OVERLOAD_PURE_NAME(SendableBuilder,void, CxxBase, "setSafeState", SetSafeState,func);    }
#endif

#ifndef RPYGEN_DISABLE_SetUpdateTable_Tstd__function_void___
    void SetUpdateTable(std::function<void ( )> func) override {
RPYBUILD_OVERLOAD_PURE_NAME(SendableBuilder,void, CxxBase, "setUpdateTable", SetUpdateTable,func);    }
#endif

#ifndef RPYGEN_DISABLE_GetEntry_KRTwpi__Twine
    nt::NetworkTableEntry GetEntry(const wpi::Twine& key) override {
RPYBUILD_OVERLOAD_PURE_NAME(SendableBuilder,nt::NetworkTableEntry, CxxBase, "getEntry", GetEntry,key);    }
#endif
...
RPYBUILD_OVERLOAD_PURE_NAME(SendableBuilder,void, CxxBase, "addBooleanProperty", AddBooleanProperty,key, getter, setter);    }
#endif
...
RPYBUILD_OVERLOAD_PURE_NAME(SendableBuilder,void, CxxBase, "addDoubleProperty", AddDoubleProperty,key, getter, setter);    }
#endif
...
RPYBUILD_OVERLOAD_PURE_NAME(SendableBuilder,void, CxxBase, "addStringProperty", AddStringProperty,key, getter, setter);    }
#endif
...
RPYBUILD_OVERLOAD_PURE_NAME(SendableBuilder,void, CxxBase, "addBooleanArrayProperty", AddBooleanArrayProperty,key, getter, setter);    }
#endif
...
RPYBUILD_OVERLOAD_PURE_NAME(SendableBuilder,void, CxxBase, "addDoubleArrayProperty", AddDoubleArrayProperty,key, getter, setter);    }
#endif
...
RPYBUILD_OVERLOAD_PURE_NAME(SendableBuilder,void, CxxBase, "addStringArrayProperty", AddStringArrayProperty,key, getter, setter);    }
#endif
...
RPYBUILD_OVERLOAD_PURE_NAME(SendableBuilder,void, CxxBase, "addRawProperty", AddRawProperty,key, getter, setter);    }
#endif
...
RPYBUILD_OVERLOAD_PURE_NAME(SendableBuilder,void, CxxBase, "addValueProperty", AddValueProperty,key, getter, setter);    }
#endif
...
RPYBUILD_OVERLOAD_PURE_NAME(SendableBuilder,void, CxxBase, "addSmallStringProperty", AddSmallStringProperty,key, getter, setter);    }
#endif
...
RPYBUILD_OVERLOAD_PURE_NAME(SendableBuilder,void, CxxBase, "addSmallBooleanArrayProperty", AddSmallBooleanArrayProperty,key, getter, setter);    }
#endif
...
RPYBUILD_OVERLOAD_PURE_NAME(SendableBuilder,void, CxxBase, "addSmallDoubleArrayProperty", AddSmallDoubleArrayProperty,key, getter, setter);    }
#endif
...
RPYBUILD_OVERLOAD_PURE_NAME(SendableBuilder,void, CxxBase, "addSmallStringArrayProperty", AddSmallStringArrayProperty,key, getter, setter);    }
#endif
...
RPYBUILD_OVERLOAD_PURE_NAME(SendableBuilder,void, CxxBase, "addSmallRawProperty", AddSmallRawProperty,key, getter, setter);    }
#endif
