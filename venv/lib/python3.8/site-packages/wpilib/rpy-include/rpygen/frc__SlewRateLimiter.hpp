...
inline void bind_frc__SlewRateLimiter(py::module &m, const char * clsName) {
...
using Rate = units::compound_unit<Unit, units::inverse<units::seconds>>;
    ...
    py::class_<typename frc::SlewRateLimiter<Unit>, std::shared_ptr<typename frc::SlewRateLimiter<Unit>>>
